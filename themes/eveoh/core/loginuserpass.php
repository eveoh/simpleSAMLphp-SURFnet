...
<body class="index" onload="initiate()">
	...
	<div id="wrapper">
		...
		<div id="header">
			<img id="logo" src="<?php echo SimpleSAML_Module::getModuleURL('eveohtheme/logo.svg'); ?>" alt="" /> <!-- DIT IS HET LOGO -->
...
-->
		...
		<div id="content">
			...
			<div class="item">
				...
				<p class="info">Some test accounts are available:</p>
				<ul>
					<li>student1 - student5</li>
					<li>staff1 - staff5</li>
				</ul>
				<p class="info">The password for these accounts is <i>password</i>.</p>
